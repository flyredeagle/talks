#!/usr/bin/env node
/**
 * generate-L05.js — Generate slide deck for Lecture 5 only
 * QM Programme · Module I.3
 *
 * Usage:  node src/generate-L05.js
 */
...
const lec = lectures.find(l => l.num === 5);
if (!lec) { console.error("Lecture 5 not found"); process.exit(1); }
