#!/usr/bin/env node
/**
 * generate-L02.js — Generate slide deck for Lecture 2 only
 * QM Programme · Module I.3
 *
 * Usage:  node src/generate-L02.js
 */
...
const lec = lectures.find(l => l.num === 2);
if (!lec) { console.error("Lecture 2 not found"); process.exit(1); }
