#!/usr/bin/env node
/**
 * generate-L10.js — Generate slide deck for Lecture 10 only
 * QM Programme · Module I.3
 *
 * Usage:  node src/generate-L10.js
 */
...
const lec = lectures.find(l => l.num === 10);
if (!lec) { console.error("Lecture 10 not found"); process.exit(1); }
