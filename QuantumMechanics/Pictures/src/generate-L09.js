#!/usr/bin/env node
/**
 * generate-L09.js — Generate slide deck for Lecture 9 only
 * QM Programme · Module I.3
 *
 * Usage:  node src/generate-L09.js
 */
...
const lec = lectures.find(l => l.num === 9);
if (!lec) { console.error("Lecture 9 not found"); process.exit(1); }
