#!/usr/bin/env node
/**
 * generate-L07.js — Generate slide deck for Lecture 7 only
 * QM Programme · Module I.3
 *
 * Usage:  node src/generate-L07.js
 */
...
const lec = lectures.find(l => l.num === 7);
if (!lec) { console.error("Lecture 7 not found"); process.exit(1); }
