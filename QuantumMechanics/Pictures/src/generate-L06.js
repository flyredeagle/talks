#!/usr/bin/env node
/**
 * generate-L06.js — Generate slide deck for Lecture 6 only
 * QM Programme · Module I.3
 *
 * Usage:  node src/generate-L06.js
 */
...
const lec = lectures.find(l => l.num === 6);
if (!lec) { console.error("Lecture 6 not found"); process.exit(1); }
