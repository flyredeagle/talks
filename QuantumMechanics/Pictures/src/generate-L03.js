#!/usr/bin/env node
/**
 * generate-L03.js — Generate slide deck for Lecture 3 only
 * QM Programme · Module I.3
 *
 * Usage:  node src/generate-L03.js
 */
...
const lec = lectures.find(l => l.num === 3);
if (!lec) { console.error("Lecture 3 not found"); process.exit(1); }
